	...
	const pcFormMembers = sequelize.define(
		"TNRTP09_PC_FORMS_MEMBERS",
		{
			...
			status: {
				...
				field: "TNTRP09_STATUS_D",
			},
			TNTRP09_DELETED_F: { type: DataTypes.BOOLEAN, defaultValue: DELETE_STATUS.NOT_DELETED },
			TNTRP09_CREATED_AT: { type: DataTypes.DATE },
			TNTRP09_UPDATED_AT: { type: DataTypes.DATE },
			TNTRP09_CREATED_D: { type: DataTypes.INTEGER },
			TNTRP09_UPDATED_D: { type: DataTypes.INTEGER },
		},
		{
