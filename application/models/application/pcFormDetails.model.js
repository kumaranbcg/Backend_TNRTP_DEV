	...
	const pcFormDetails = sequelize.define(
		"TNRTP08_PC_FORMS_DETAILS",
		{
			...
			status: {
				...
				field: "TNTRP08_STATUS_D",
			},
			TNTRP08_DELETED_F: { type: DataTypes.BOOLEAN, defaultValue: DELETE_STATUS.NOT_DELETED },
			TNTRP08_CREATED_AT: { type: DataTypes.DATE },
			TNTRP08_UPDATED_AT: { type: DataTypes.DATE },
			TNTRP08_CREATED_D: { type: DataTypes.INTEGER },
			TNTRP08_UPDATED_D: { type: DataTypes.INTEGER },
		},
		{
