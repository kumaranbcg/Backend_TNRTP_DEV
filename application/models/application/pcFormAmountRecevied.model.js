...
module.exports = (sequelize, DataTypes) => {
	const pcFormAmountRecevied = sequelize.define(
		"TNRTP10_PC_FORMS_AMOUNT_RECEIVED",
		{
			...
			amtGrant: { type: DataTypes.INTEGER, field: "TNRTP10_AMOUNT_RECEIVED_GRANT_D" },
			amtReceviedLoan: { type: DataTypes.INTEGER, field: "TNRTP10_AMOUNT_RECEIVED_LOAN_D" },
			...
			amtRecevied: { type: DataTypes.INTEGER, field: "TNRTP10_AMOUNT_RECEIVED_D" },
			shareCapital: { type: DataTypes.INTEGER, field: "TNRTP10_SHARE_CAPITAL_D" },
			...
			status: {
				...
				field: "TNTRP10_STATUS_D",
			},
			TNTRP10_DELETED_F: { type: DataTypes.INTEGER, defaultValue: DELETE_STATUS.NOT_DELETED },
			TNTRP10_CREATED_AT: { type: DataTypes.DATE },
			TNTRP10_UPDATED_AT: { type: DataTypes.DATE },
			TNTRP10_CREATED_D: { type: DataTypes.INTEGER },
			TNTRP10_UPDATED_D: { type: DataTypes.INTEGER },
		},
		{
