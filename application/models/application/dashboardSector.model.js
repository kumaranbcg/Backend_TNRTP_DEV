module.exports = (sequelize, DataTypes) => {
	const dashboardSector = sequelize.define(
		"TNRTP106_DASHBOARD_SECTOR_MASTER",
		{
			...
			dashboardMasterId: { type: DataTypes.INTEGER, field: "TNRTP106_DASHBOARD_FORMS_MASTER_D" },
			value: { type: DataTypes.INTEGER, field: "TNRTP106_TYPE_OF_SECTOR_MASTER_D" },
	...
	dashboardSector.selectedFields = ["value"];
