...
module.exports = (sequelize, DataTypes) => {
	const symrSkillTraining = sequelize.define(
		"TNRTP79_SYMR_SKILL_TRAINING",
		{
		    ...
		    skillTrainingScheme: { type: DataTypes.INTEGER, field: "TNRTP79_SKILL_TRAINING_SCHEME_MASTER_D" },
		    ...
		    courseCompletionYear: { type: DataTypes.INTEGER, field: "TNRTP79_COURSE_COMPLETION_YEAR_MASTER_D" },
			isCompletedEdpProgramme: { type: DataTypes.BOOLEAN, field: "TNRTP79_IS_ENTREPRENEUR_PROGRAMME_COMPLETED_D" },
            edpCompletedInstituteName: { type: DataTypes.STRING, field: "TNRTP79_EDP_COMPLETED_INSTITUTE_NAME_N" },
			edpCompletedCourseName: { type: DataTypes.STRING, field: "TNRTP79_EDP_COMPLETED_COURSE_NAME_N" },
		    edpScheme: { type: DataTypes.INTEGER, field: "TNRTP79_EDP_SCHEME_MASTER_D" },
			isRegisteredEdpProgramme: { type: DataTypes.BOOLEAN, field: "TNRTP79_IS_EDP_PROGRAMME_REGISTERED_D" },
            edpRegisteredInstituteName: { type: DataTypes.STRING, field: "TNRTP79_EDP_REGISTERED_INSTITUTE_NAME_N" },
			edpRegisteredCourseName: { type: DataTypes.STRING, field: "TNRTP79_EDP_REGISTERED_COURSE_NAME_N" },
		    registeredEdpScheme: { type: DataTypes.INTEGER, field: "TNRTP79_REGISTERED_EDP_SCHEME_MASTER_D" },
			status: {
				type: DataTypes.INTEGER,
