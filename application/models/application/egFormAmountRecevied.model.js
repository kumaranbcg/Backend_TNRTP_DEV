...
module.exports = (sequelize, DataTypes) => {
	const egFormAmountRecevied = sequelize.define(
		"TNRTP57_EG_FORMS_AMOUNT_RECEIVED",
		{
			...
			amtGrant: { type: DataTypes.INTEGER, field: "TNRTP57_AMOUNT_RECEIVED_GRANT_D" },
			amtReceviedLoan: { type: DataTypes.INTEGER, field: "TNRTP57_AMOUNT_RECEIVED_LOAN_D" },
			...
			amtRecevied: { type: DataTypes.INTEGER, field: "TNRTP57_AMOUNT_RECEIVED_D" },
