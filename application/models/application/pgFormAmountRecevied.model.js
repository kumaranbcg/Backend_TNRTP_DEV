...
module.exports = (sequelize, DataTypes) => {
	const pgFormAmountRecevied = sequelize.define(
		"TNRTP40_PG_FORMS_AMOUNT_RECEIVED",
		{
			...
			amtGrant: { type: DataTypes.BIGINT, field: "TNRTP40_AMOUNT_RECEIVED_GRANT_D" },
			amtReceviedLoan: { type: DataTypes.BIGINT, field: "TNRTP40_AMOUNT_RECEIVED_LOAN_D" },
			...
			amtRecevied: { type: DataTypes.BIGINT, field: "TNRTP40_AMOUNT_RECEIVED_D" },
