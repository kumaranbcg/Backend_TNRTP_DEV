	...
	const pcFormBasicDetails = sequelize.define(
		"TNRTP07_PC_FORMS_BASIC_DETAILS",
		{
			...
			status: {
				...
				field: "TNTRP07_STATUS_D",
			},
			TNTRP07_DELETED_F: { type: DataTypes.BOOLEAN, defaultValue: DELETE_STATUS.NOT_DELETED },
			TNTRP07_CREATED_AT: { type: DataTypes.DATE },
			TNTRP07_UPDATED_AT: { type: DataTypes.DATE },
			TNTRP07_CREATED_D: { type: DataTypes.INTEGER },
			TNTRP07_UPDATED_D: { type: DataTypes.INTEGER },
		},
		{
